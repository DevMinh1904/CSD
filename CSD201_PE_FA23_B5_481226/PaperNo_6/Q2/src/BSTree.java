...
//Do not edit this function. Your task is to complete insert function above only.
    void insert(String xRiver, int xFeature, int xWeight) {
        if (xRiver.charAt(0) == 'A') {
            return;
        }
        insertV1(new Carp(xRiver, xFeature, xWeight));
    }
...
//=============================================================
    ...
    void f3() throws Exception {
      ...
      Your task is to insert statements here, just after this comment,
      to complete the question in the exam paper.*/
        Node q = inorderToFindNodeQ(root);
        Node rightMost = q.left;
        while(rightMost.right != null){
            rightMost = rightMost.right;
        }
        rightMost.info.feature = 88;
        deleteByCopy(q);
    ...
    public Node inorderToFindNodeQ(Node p){
        if(p == null){
            return null;
        }
        inorderToFindNodeQ(p.left);
        if(p.left != null && p.right != null){
            return p;
        }
        inorderToFindNodeQ(p.right);
        return null;
    }
